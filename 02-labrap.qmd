...
Prosentvis andel MHC I, -IIa og -IIx før og etter de fem treningsøktene er vist i @tbl-genuttrykk. Genuttrykket for MHC I gikk opp fra 18,16% før treningsintervensjonen til 45,54% etter treningsintervensjonen, og fra 57,84% til 85,77% for MHC IIa. Genuttrykket for MHC IIx gikk derimot ned, fra 24,01% til 3,53%.
...
Det ble regnet ut CV for triplikatene MHC I, IIa og IIx for W0 og W2. @tbl-mhc-cv viser lav varians i målingene, med unntak av MHC 1 for W2 som hadde en CV på 23,52.
...
```{r}
#| label: "fig-fortynningsrekke"
#| fig-cap: "Lineær fremstilling av fortynningsrekken"
#| warning: false
#| message: false
#| echo: false
