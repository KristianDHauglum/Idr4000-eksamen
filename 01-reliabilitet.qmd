...
datasett %>%
        ...
        cols_label(n = "Deltakere",
                   ...
                   høydeMean = "Høyde (cm)",
                   høydesd = "") %>% 
  tab_footnote(footnote = "Verdier er oppgitt som gjennomsnitt ± standardavvik")
...
```{r}
#| label: fig-1
#| fig-cap: "Viser endring i MAOD fra test 1 til test 2 for hver deltaker"
#| echo: false
#| message: false
#| warning: false
...
Med reliabilitet mener vi reproduserbarheten til en test, analyse eller annen måling i gjentatte forsøk på de samme individene [@hopkins2000]. @hopkins2000 viser til tre måter å måle reliabilitet på «within-subject random variation», «systematic change in the mean» og «retest correlation».
